...
%%Read in absorption file for blank
   ...
   %%% flucut the blank
    ...
    %% Set up options for flucut
        ...
        A = zeros(1,125,561); % Create dataframe to feed to flucut
   ...
   y = QS_flucutwithife_data.data(:,26:125,451) %Ex=350, Em=290-700 by 3nm Cartisano et al 2018
    ...
    %%% iNT value starna for RU %%%
       y = sarna_flucutwithife_data.data(:,50:81,451);  %Following Lawaetz and Stedmon 2008; Ex=350, Em=371-428 by 3nm steps
    % calculating the area under the curve
    raman1 = nansum(y);
    clear y
